...
public abstract class ExtendedMapFeedbackAdapter extends MapFeedbackAdapter
  ...
  public void toggleFolded() {
    getActorFactory()
        ...
        .toggleFolded(getViewAbstraction().getSelecteds().listIterator());
  }
  ...
  public void applyPattern(MindMapNode pNode, Pattern pPattern) {
    StylePatternFactory.applyPattern(
        ...
        Collections.<MindMapControllerPlugin>emptySet(),
        this);
  }

  public void setNodeStyle(MindMapNode pNode, NodeStyle pStyle) {

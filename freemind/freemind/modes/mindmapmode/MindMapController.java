...
public class MindMapController extends ControllerAdapter
  ...
  private void createStandardActions() {
    ...
    fork = new NodeStyleAction(this, NodeStyle.FORK);
    bubble = new NodeStyleAction(this, NodeStyle.BUBBLE);
  ...
  public MindMapNode loadTree(Tools.ReaderCreator pReaderCreator)
    ...
    return getMap()
        .loadTree(
            pReaderCreator,
            new AskUserBeforeUpdateCallback() {
    ...
    for (RegistrationContainer container : pluginRegistrations) {
      ...
      try {
        ...
        Constructor hookConstructor =
            registrationClass.getConstructor(new Class[] {ModeController.class, MindMap.class});
  ...
  /** */
  public void setNodeStyle(MindMapNode node, NodeStyle style) {
  ...
  protected void setLinkByFileChooser() {
    ...
    if (relative != null) setLink((NodeAdapter) getSelected(), relative);
  }

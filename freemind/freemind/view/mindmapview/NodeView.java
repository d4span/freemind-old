...
public class NodeView extends JComponent implements TreeModelListener {
  ...
  public NodeView getParentView() {
    final Container parent = getParent();
    if (parent instanceof NodeView) return (NodeView) parent;
    return null;
  }

  public NodeView getVisibleParentView() {
    final Container parent = getParent();
    if (!(parent instanceof NodeView)) return null;
    NodeView parentView = (NodeView) parent;
  ...
  public void updateToolTip() {
    ...
    if (tooltips.size() == 0) {
      ...
      // html table
      StringBuffer text = new StringBuffer("<html><table width=\"" + getMaxToolTipWidth() + "\">");

 ...
 */
    ...
    override fun startupMapHook() {
        ...
        if (image != null) {
            val imageType = getResourceString("image_type")
     ...
     * Export image.
     */
    fun exportToImage(image: BufferedImage?, type: String?,
                      description: String?): Boolean {
        val chosenFile = chooseFile(type!!, description, null) ?: return false
        try {

 ...
 * @author foltin
 */
class NodeAttributeTable : MindMapNodeHookAdapter() {
     ...
     * @return
     */
    private val registration: NodeAttributeTableRegistration
        private get() = getPluginBaseClass() as NodeAttributeTableRegistration
    ...
    private fun setShowSplitPaneProperty(pValue: Boolean) {
        mindMapController!!.setProperty(FreeMind.RESOURCES_SHOW_ATTRIBUTE_PANE,

 ...
 * @author foltin
 */
class RemindValueProperty(pDescription: String?, pLabel: String?,
                          private val mTextTranslator: TextTranslator) : ThreeCheckBoxProperty(pDescription, pLabel) {
    init {
        mDontTouchValue = ""
    }
    ...
    override fun setState(newState: Int) {
        ...
        strings[ThreeCheckBoxProperty.Companion.TRUE_VALUE_INT] = mTextTranslator.getText(
                "OptionalDontShowMeAgainDialog.ok").replaceFirst("&".toRegex(), "")
        strings[ThreeCheckBoxProperty.Companion.FALSE_VALUE_INT] = mTextTranslator.getText(
                "OptionalDontShowMeAgainDialog.cancel").replaceFirst("&".toRegex(), "")
        strings[ThreeCheckBoxProperty.Companion.DON_T_TOUCH_VALUE_INT] = mTextTranslator.getText(
                "OptionPanel.ask").replaceFirst("&".toRegex(), "")
        mButton.text = strings[state]
    }
}
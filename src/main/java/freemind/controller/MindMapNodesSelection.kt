...
(private val nodesContent: String, private val imageContent: String,
 ...
 private var dropActionContent: String, private val fileList: List<*>, private val nodeIdsContent: List<String>) : Transferable, ClipboardOwner {
    ...
    override fun isDataFlavorSupported(flavor: DataFlavor): Boolean {
        ...
        return if (flavor.equals(copyNodeIdsFlavor) && nodeIdsContent != null) {
            true
        } else false
    }

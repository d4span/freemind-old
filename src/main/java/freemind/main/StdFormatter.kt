...
internal class StdFormatter : SimpleFormatter() {
    private class StdOutErrLevel(name: String?, value: Int) : Level(name, value)
    ...
    override fun format(record: LogRecord): String {
        if (STDERR.name != record.loggerName
                && STDOUT.name != record.loggerName) {
    ...
    companion object {
         ...
         */
        val STDOUT: Level = StdOutErrLevel("STDOUT",
                Level.WARNING.intValue() + 53)

        /**
         * Level for STDERR activity
         */
        val STDERR: Level = StdOutErrLevel("STDERR",

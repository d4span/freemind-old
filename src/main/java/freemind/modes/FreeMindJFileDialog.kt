 ...
 * @date 23.02.2012
 */
class FreeMindJFileDialog : JFileChooser(), FreeMindFileDialog {
    ...
    protected fun callDirectoryListener(result: Int) {
        if (result == APPROVE_OPTION && mDirectoryResultListener != null) {
            try {
                mDirectoryResultListener!!.setChosenDirectory(currentDirectory)
            } catch (e: Exception) {
    ...
    override fun showOpenDialog(pParent: Component): Int {
        ...
        val result = super.showOpenDialog(pParent)
    ...
    override fun showSaveDialog(pParent: Component): Int {
        val result = super.showSaveDialog(pParent)
        callDirectoryListener(result)
        return result
    }

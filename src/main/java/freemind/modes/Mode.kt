...
abstract class Mode {
    abstract fun init(c: Controller)
     ...
     */
    abstract fun createModeController(): ModeController

    /**
     * This modeController is only used, when no map is opened.
     */
    abstract val defaultModeController: ModeController?
    abstract val controller: Controller?
    fun toLocalizedString(): String {
        return controller!!.getResourceString("mode_" + toString())
    }
}
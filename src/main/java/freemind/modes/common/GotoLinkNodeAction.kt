...
class GotoLinkNodeAction(private val controller: ModeController, var source: MindMapNode?) : AbstractAction(controller.getText("goto_link_node_action"), ImageFactory.getInstance().createIcon(
    ...
    init {
        ...
        if (source != null) {
            ...
            putValue(NAME, controller.getText("follow_graphical_link")
                    + adaptedText)

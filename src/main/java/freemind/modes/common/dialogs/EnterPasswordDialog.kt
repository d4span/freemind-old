...
class EnterPasswordDialog : JDialog {
     ...
     */
    constructor(caller: JFrame?, pTranslator: TextTranslator?,
                enterTwoPasswords: Boolean) : super(caller, "", true /* =modal */) {
    ...
    private fun getJCancelButton(): JButton {
        if (jCancelButton == null) {
            ...
            jCancelButton!!.text = mTranslator

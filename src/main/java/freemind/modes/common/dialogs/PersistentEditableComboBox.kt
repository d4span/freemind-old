...
class PersistentEditableComboBox(private val mModeController: ModeController,
                                 private val pStorageKey: String) : JComboBox<Any?>() {
    ...
    private fun addUrl(selectedItem: String, calledFromSetText: Boolean): Boolean {
        ...
        if (calledFromSetText) {
            ...
            mModeController.frame.setProperty(pStorageKey,

...
class CommonNodeMouseMotionListener(private val c: ModeController) : NodeMouseMotionObserver {
    ...
    fun createTimer(e: MouseEvent) {
        ...
        timerForDelayedSelection.schedule(
				 ...
				 * direct selection.
				 */
                if (delayedSelectionEnabled!!.value) timeForDelayedSelection
                        .value else 0.toLong())
    }
    ...
    protected inner class timeDelayedSelection internal constructor(private val c: ModeController, private val e: MouseEvent) : TimerTask() {
    ...
    companion object {
        ...
        private var timeForDelayedSelection: Tools.IntHolder? = null

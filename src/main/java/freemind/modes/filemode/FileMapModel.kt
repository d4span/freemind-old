...
class FileMapModel(root: File?, frame: FreeMindMain?,
                   modeController: ModeController?) : MapAdapter(modeController) {
    private override val linkRegistry: MindMapLinkRegistry

    //
    // Constructors
    //
    constructor(frame: FreeMindMain?, modeController: ModeController?) : this(File(File.separator), frame, modeController) {}

...
javax.swing.*
class BoldAction(modeController: MindMapController) : NodeGeneralAction(modeController, "bold", "images/Bold16.gif"), MenuItemSelectedListener {
    /**
     */
    init {
        setDoActionClass(BoldNodeAction::class.java)
    }

    override fun isSelected(item: JMenuItem?, action: Action?): Boolean {
        return modeController.selected.isBold
    }
}
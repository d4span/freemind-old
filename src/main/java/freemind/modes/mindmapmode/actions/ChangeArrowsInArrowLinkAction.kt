...
class ChangeArrowsInArrowLinkAction(private val controller: MindMapController,
                                    text: String?, iconPath: String?, var arrowLink: MindMapArrowLinkModel?,
                                    var hasStartArrow: Boolean, var hasEndArrow: Boolean) : MindmapAction("change_arrows_in_arrow_link", iconPath, controller) {
    override fun actionPerformed(e: ActionEvent) {
        controller.actorFactory.changeArrowsInArrowLinkActor

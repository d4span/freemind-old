...
class CutAction(c: MindMapController) : AbstractAction(c.getText("cut"), ImageFactory.getInstance().createIcon(
    ...
    init {
        ...
        mMindMapController = c
        isEnabled = false
    }

    override fun actionPerformed(e: ActionEvent) {
        if (mMindMapController.view.root.isSelected) {
            mMindMapController.controller.errorMessage(
                    mMindMapController.frame.getResourceString(
                            "cannot_delete_root"))
            return
        }
        val showResult = OptionalDontShowMeAgainDialog(mMindMapController
                .frame.jFrame, mMindMapController.selectedView,
        ...
        val copy = mMindMapController.cut()
        // and set it.
        mMindMapController.clipboardContents = copy
        mMindMapController.controller.obtainFocusForSelected()
    }

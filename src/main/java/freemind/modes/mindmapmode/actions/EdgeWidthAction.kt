...
javax.swing.*
class EdgeWidthAction(controller: MindMapController, val width: Int) : NodeGeneralAction(controller, null, null), MenuItemSelectedListener {
	 ...
	 */
    override fun getActionPair(pSelected: MindMapNodeModel): ActionPair? {
        return mindMapController.actorFactory.edgeWidthActor.getActionPair(pSelected, width)
    }
    ...
    override fun isSelected(pCheckItem: JMenuItem?, pAction: Action?): Boolean {
        val width = mindMapController.selected.edge.realWidth
        return width == this.width
    }

    companion object {
        private fun getWidthTitle(controller: MindMapController, width: Int): String? {
            val returnValue: String?
            returnValue = if (width == EdgeAdapter.Companion.WIDTH_PARENT) {
                controller.getText("edge_width_parent")
            } else if (width == EdgeAdapter.Companion.WIDTH_THIN) {
                controller.getText("edge_width_thin")
            } else {

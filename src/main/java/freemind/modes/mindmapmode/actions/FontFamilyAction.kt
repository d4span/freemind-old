 ...
 * @author foltin
 */
class FontFamilyAction(modeController: MindMapController) : NodeGeneralAction(modeController, "font_family", null, null as NodeActorXml?) {
    /** This action is used for all fonts, which have to be set first.  */
    private var actionFont: String?

    /**
     */
    init {
        // default value:
        actionFont = modeController.frame.getProperty("defaultfont")
    }

    fun actionPerformed(font: String?) {
        actionFont = font
    ...
    override fun getActionPair(pSelected: MindMapNodeModel): ActionPair? {
        return mindMapController.actorFactory.fontFamilyActor.getActionPair(pSelected, actionFont)
    }
}
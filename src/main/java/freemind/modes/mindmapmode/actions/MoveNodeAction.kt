...
class MoveNodeAction(modeController: MindMapController) : NodeGeneralAction(modeController, "reset_node_position", null as String?) {
    /**
     */
    init {
        setDoActionClass(MoveNodeXmlAction::class.java)
    }
}
...
class NodeBackgroundColorAction(private val controller: MindMapController) : MindmapAction("node_background_color", null as String?, controller) {
    override fun actionPerformed(e: ActionEvent) {
        val color = Controller.showCommonJColorChooserDialog(controller
                ...
                .selected.backgroundColor) ?: return
        for (selected in controller.selecteds) {
            controller.setNodeBackgroundColor(selected, color)
        }
    }

    class RemoveNodeBackgroundColorAction(
            controller: MindMapController) : NodeGeneralAction(controller, "remove_node_background_color", null as String?) {
        init {

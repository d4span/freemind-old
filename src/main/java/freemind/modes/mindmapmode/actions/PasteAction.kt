...
class PasteAction(private val mMindMapController: MindMapController) : AbstractAction(mMindMapController.getText("paste"), ImageFactory.getInstance().createIcon(
        mMindMapController.getResource("images/editpaste.png"))) {
    init {
        if (logger == null) {
    ...
    override fun actionPerformed(e: ActionEvent) {
        val clipboardContents = mMindMapController
                .clipboardContents
        val selectedNode = mMindMapController.selected
        mMindMapController.paste(clipboardContents, selectedNode)
    }
	 ...
	 */
    val doActionClass: Class<PasteNodeAction>

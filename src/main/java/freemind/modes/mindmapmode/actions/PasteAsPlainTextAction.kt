 ...
 * @date 18.10.2011
 */
class PasteAsPlainTextAction(private val mMindMapController: MindMapController) : AbstractAction(mMindMapController.getText("paste_as_plain_text"), null) {
    init {
        if (logger == null) {
    ...
    override fun actionPerformed(pArg0: ActionEvent) {
        ...
        if (clipboardContents!!.isDataFlavorSupported(DataFlavor.stringFlavor)) {
            try {
                ...
                val newNode = mMindMapController.addNewNode(selected,

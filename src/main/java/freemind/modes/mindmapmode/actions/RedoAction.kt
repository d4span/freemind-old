...
class RedoAction(private val controller: MindMapController) : UndoAction(controller, controller.getText("redo"), ImageFactory.getInstance().createIcon(
        controller.getResource("images/redo.png")), controller) {
    /**
     */
    override fun informUndoPartner(pair: ActionPair) {
        this.controller.undo!!.add(pair.reverse())
        this.controller.undo!!.isEnabled = true
    }
}
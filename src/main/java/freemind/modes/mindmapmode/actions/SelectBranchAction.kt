...
/**  */
class SelectBranchAction
/**
 *
 */
(modeController: MindMapController) : MindmapAction("select_branch", null as String?, modeController) {
    override fun actionPerformed(e: ActionEvent) {
        mindMapController.selectBranch(
                mindMapController.selectedView, true /* = extend */)
    }
}
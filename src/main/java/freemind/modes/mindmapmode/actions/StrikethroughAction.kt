...
javax.swing.*
class StrikethroughAction(modeController: MindMapController) : NodeGeneralAction(modeController, "Strikethrough", "images/format-text-strikethrough.png"), MenuItemSelectedListener {
    /**
     */
    init {
        setDoActionClass(StrikethroughNodeAction::class.java)
    }

    override fun isSelected(item: JMenuItem?, action: Action?): Boolean {
        return modeController.selected.isStrikethrough
    }
}
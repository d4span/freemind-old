...
class UseRichFormattingAction(modeController: MindMapController) // public boolean isEnabled() {
// if (1 == 0) {
...
// return true;
// }
    : NodeGeneralAction(modeController, "use_rich_formatting", null,
        SingleNodeOperation { map, selected -> // modeController.getController().setProperty(
            // "use_rich_text_in_new_long_nodes", "true");
            val nodeText = selected.text

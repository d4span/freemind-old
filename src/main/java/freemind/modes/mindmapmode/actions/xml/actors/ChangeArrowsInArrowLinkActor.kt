...
(pMapFeedback: ExtendedMapFeedback) : XmlActorAdapter(pMapFeedback) {
    ...
    /**
     */
    private fun getActionPair(arrowLink2: MindMapArrowLink?,
                              hasStartArrow2: Boolean, hasEndArrow2: Boolean): ActionPair {
        return ActionPair(createArrowLinkArrowXmlAction(arrowLink2,
    ...
    override val doActionClass: Class<*>
        get() = ArrowLinkArrowXmlAction::class.java

    private fun createArrowLinkArrowXmlAction(
            arrowLink: MindMapArrowLink?, hasStartArrow: Boolean,
            hasEndArrow: Boolean): ArrowLinkArrowXmlAction {
        return createArrowLinkArrowXmlAction(arrowLink,
                if (hasStartArrow) "Default" else "None", if (hasEndArrow) "Default" else "None")
    }

    private fun createArrowLinkArrowXmlAction(
            arrowLink: MindMapArrowLink?, hasStartArrow: String?,
            hasEndArrow: String?): ArrowLinkArrowXmlAction {
        val action = ArrowLinkArrowXmlAction()
        action.startArrow = hasStartArrow
        action.endArrow = hasEndArrow
        action.id = arrowLink.getUniqueId()
        return action
    }
}
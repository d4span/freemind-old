...
(pMapFeedback: ExtendedMapFeedback) : XmlActorAdapter(pMapFeedback) {
    ...
    override val doActionClass: Class<*>
        get() = InsertAttributeAction::class.java

    fun getActionPair(selected: MindMapNode?, pPosition: Int,
                      pAttribute: Attribute?): ActionPair {
        val insertAttributeAction = getInsertAttributeAction(selected,
                pPosition, pAttribute)
        val undoInsertAttributeAction = xmlActorFactory.removeAttributeActor.getRemoveAttributeAction(selected, pPosition)
     ...
     * @return
     */
    fun getInsertAttributeAction(pSelected: MindMapNode?,
                                 pPosition: Int, pAttribute: Attribute?): InsertAttributeAction {
        val insertAttributeAction = InsertAttributeAction()
        insertAttributeAction.node = getNodeID(pSelected)
        insertAttributeAction.name = pAttribute.getName()
        insertAttributeAction.value = pAttribute.getValue()

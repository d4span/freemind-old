...
abstract class XmlActorAdapter(
     ...
     * @return
     */
    @get:Deprecated("""replaced by {@link XmlActorAdapter#getExMapFeedback()}
	  """)
    protected val modeController: MindMapController
        protected get() = exMapFeedback as MindMapController
    ...
    protected val selected: MindMapNode?
        protected get() = exMapFeedback.selected
    ...
    protected fun addActor(actor: ActorXml?) {
        if (actor != null) {
            // registration:
            exMapFeedback.actionRegistry.registerActor(actor,
                    actor.doActionClass)
        }
    }

    protected val xmlActorFactory: XmlActorFactory?
        protected get() = exMapFeedback.actorFactory

 ...
 * @date 16.03.2014
 */
class XmlActorFactory(private val mMapFeedback: ExtendedMapFeedback) {
    val italicActor: ItalicNodeActor
    val boldActor: BoldNodeActor
    var strikethroughActor: StrikethroughNodeActor
    val newChildActor: NewChildActor
    val deleteChildActor: DeleteChildActor
    val pasteActor: PasteActor
    val removeAllIconsActor: RemoveAllIconsActor
    val addIconActor: AddIconActor
    val removeIconActor: RemoveIconActor
    val cloudActor: CloudActor
    val edgeStyleActor: EdgeStyleActor
    val edgeWidthActor: EdgeWidthActor
    val fontFamilyActor: FontFamilyActor
    val fontSizeActor: FontSizeActor
    val moveNodeActor: MoveNodeActor
    val nodeStyleActor: NodeStyleActor
    val underlineActor: UnderlineActor
    val addArrowLinkActor: AddArrowLinkActor
    val removeArrowLinkActor: RemoveArrowLinkActor
    val changeArrowLinkEndPointsActor: ChangeArrowLinkEndPointsActor
    val changeArrowsInArrowLinkActor: ChangeArrowsInArrowLinkActor
    val cloudColorActor: CloudColorActor
    val colorArrowLinkActor: ColorArrowLinkActor
    val edgeColorActor: EdgeColorActor
    val editActor: EditActor
    val nodeBackgroundColorActor: NodeBackgroundColorActor
    val nodeColorActor: NodeColorActor
    val addHookActor: AddHookActor
    val nodeUpActor: NodeUpActor
    val revertActor: RevertActor
    val toggleFoldedActor: ToggleFoldedActor
    val setLinkActor: SetLinkActor
    val addAttributeActor: AddAttributeActor
    val insertAttributeActor: InsertAttributeActor
    val removeAttributeActor: RemoveAttributeActor
    val setAttributeActor: SetAttributeActor
    val cutActor: CutActor
    val compoundActor: CompoundActor
    val undoPasteActor: UndoPasteActor
    val changeNoteTextActor: ChangeNoteTextActor

    init {
        italicActor = ItalicNodeActor(mMapFeedback)
        boldActor = BoldNodeActor(mMapFeedback)
        strikethroughActor = StrikethroughNodeActor(mMapFeedback)
        newChildActor = NewChildActor(mMapFeedback)
        deleteChildActor = DeleteChildActor(mMapFeedback)
        pasteActor = PasteActor(mMapFeedback)
        removeAllIconsActor = RemoveAllIconsActor(mMapFeedback)
        addIconActor = AddIconActor(mMapFeedback)
        removeIconActor = RemoveIconActor(mMapFeedback)
        cloudActor = CloudActor(mMapFeedback)
        edgeStyleActor = EdgeStyleActor(mMapFeedback)
        edgeWidthActor = EdgeWidthActor(mMapFeedback)
        fontFamilyActor = FontFamilyActor(mMapFeedback)
        fontSizeActor = FontSizeActor(mMapFeedback)
        moveNodeActor = MoveNodeActor(mMapFeedback)
        nodeStyleActor = NodeStyleActor(mMapFeedback)
        underlineActor = UnderlineActor(mMapFeedback)
        addArrowLinkActor = AddArrowLinkActor(mMapFeedback)
        removeArrowLinkActor = RemoveArrowLinkActor(mMapFeedback)
        changeArrowLinkEndPointsActor = ChangeArrowLinkEndPointsActor(mMapFeedback)
        changeArrowsInArrowLinkActor = ChangeArrowsInArrowLinkActor(mMapFeedback)
        cloudColorActor = CloudColorActor(mMapFeedback)
        colorArrowLinkActor = ColorArrowLinkActor(mMapFeedback)
        edgeColorActor = EdgeColorActor(mMapFeedback)
        editActor = EditActor(mMapFeedback)
        nodeBackgroundColorActor = NodeBackgroundColorActor(mMapFeedback)
        nodeColorActor = NodeColorActor(mMapFeedback)
        addHookActor = AddHookActor(mMapFeedback)
        nodeUpActor = NodeUpActor(mMapFeedback)
        revertActor = RevertActor(mMapFeedback)
        toggleFoldedActor = ToggleFoldedActor(mMapFeedback)
        setLinkActor = SetLinkActor(mMapFeedback)
        addAttributeActor = AddAttributeActor(mMapFeedback)
        insertAttributeActor = InsertAttributeActor(mMapFeedback)
        removeAttributeActor = RemoveAttributeActor(mMapFeedback)
        setAttributeActor = SetAttributeActor(mMapFeedback)
        compoundActor = CompoundActor(mMapFeedback)
        cutActor = CutActor(mMapFeedback)
        undoPasteActor = UndoPasteActor(mMapFeedback)
        changeNoteTextActor = ChangeNoteTextActor(mMapFeedback)
    }
}
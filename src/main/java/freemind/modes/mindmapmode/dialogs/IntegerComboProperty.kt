...
(pDescription: String?, pLabel: String?,
 pPossibles: Array<String>?, pSizesVector: Vector<String>?) : ComboProperty(pDescription!!, pLabel!!, pPossibles!!, pSizesVector) {
    /*
	 * (non-Javadoc)
	 * 
    ...
    override var value: String
        ...
        set(pValue) {
            ...
            if (possibleValues!!.contains(pValue)) {
                ...
                val givenVal: Int
                try {
                    givenVal = pValue.toInt()
                    for (stringValue in possibleValues!!) {
                        val `val` = stringValue.toInt()
                        if (`val` > givenVal && lastMatchedValue != null) {
                            super.value = lastMatchedValue
                            return
                        }

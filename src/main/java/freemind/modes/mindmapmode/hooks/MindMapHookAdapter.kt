...
/**  */
open class MindMapHookAdapter
/**
 *
 */
    : ModeControllerHookAdapter() {
    open val mindMapController: MindMapController?
        get() = getController() as MindMapController?

    fun addAccelerator(menuItem: JMenuItem, key: String): JMenuItem {
        val keyProp = mindMapController.getFrame().getProperty(key)
        if (keyProp == null) {

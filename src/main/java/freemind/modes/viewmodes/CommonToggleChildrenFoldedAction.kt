 ...
 * @author foltin
 */
class CommonToggleChildrenFoldedAction(private val modeController: ViewControllerAdapter) : AbstractAction(modeController.getText("toggle_children_folded")) {
    ...
    override fun actionPerformed(e: ActionEvent) {
        val selected = modeController.selectedView
        modeController.toggleFolded!!.toggleFolded(selected!!.model
                .childrenUnfolded())
        modeController.view.selectAsTheOnlyOneSelected(selected)
        modeController.controller.obtainFocusForSelected()
    }
}
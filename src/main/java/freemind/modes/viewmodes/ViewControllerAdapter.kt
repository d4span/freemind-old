 ...
 * @author foltin
 */
abstract class ViewControllerAdapter(mode: Mode?) : ControllerAdapter(mode) {
    var toggleFolded: CommonToggleFoldedAction? = null
    var toggleChildrenFolded: CommonToggleChildrenFoldedAction? = null
     ...
     */
    init {
        toggleFolded = CommonToggleFoldedAction(this)
        toggleChildrenFolded = CommonToggleChildrenFoldedAction(this)
    ...
    override fun extendSelection(e: MouseEvent?): Boolean {
        ...
        if (retValue) {
            ...
            var link = newlySelectedNodeView.model.link
            link = link ?: " "
    ...
    override fun setFolded(node: MindMapNode, folded: Boolean) {
        requireNotNull(node) { "setFolded was called with a null node." }
    ...
    override fun startupController() {
        ...
        mapMouseMotionListener.register(
                CommonMouseMotionManager(this))
        nodeKeyListener.register(
                CommonNodeKeyListener(this) { e, addNew, editLong ->
                    // no edit.
                })
    }

 ...
 */
class EditNodeExternalApplication(node: NodeView, text: String,
                                  protected val firstEvent: KeyEvent, controller: ModeController,
        ...
        object : Thread() {
            override fun run() {
                ...
                try {
                    ...
                    val content = getFile(temporaryFile)
                    if (content == null) {
                        editControl.cancel()
                    }

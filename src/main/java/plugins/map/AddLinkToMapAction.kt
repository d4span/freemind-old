 ...
 * @date 22.12.2011
 */
class AddLinkToMapAction : MindMapNodeHookAdapter() {
    /*
	 * (non-Javadoc)
	 * 
	 * @see
    ...
    override fun invoke(pNode: MindMapNode?) {
        ...
        for (node in selecteds) {
            ...
            if (hook != null) {
                ...
                mindMapController!!.setLink(node, FreeMindMapController.Companion.getLink(hook))
            }
        }
    }

    companion object {
        const val NODE_CONTEXT_PLUGIN_NAME = "plugins/map/MapDialog_AddLinkToMapAction.properties"
    }
}
...
/**
 * Separate out methods from [SearchControllerHook] that we need in
 * [SearchViewPanel] so we can pass in [SearchControllerHook] or a test class
 *
 *
...
interface ISearchController {
    ...
    val jFrame: JFrame
    val filesOfOpenTabs: Array<File?>

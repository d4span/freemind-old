...
class CalendarMarkingTests : FreeMindTestBase() {
    @Throws(Exception::class)
    fun testCalendarMarkingEmpty() {
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings/>") as CalendarMarkings
        assertEquals(0, result.sizeCalendarMarkingList())
    }

    @Throws(Exception::class)
    fun testCalendarMarkingSingle() {
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla' color='#ff69b4' start_date='1437213300000' repeat_type='never'/>" +
                "</calendar_markings>") as CalendarMarkings
        assertEquals(1, result.sizeCalendarMarkingList())
        val ev = CalendarMarkingEvaluator(result)
        val cal = Calendar.getInstance()
        cal.timeInMillis = result.getCalendarMarking(0).startDate
    ...
    @Throws(Exception::class)
    fun testCalendarMarkingDouble() {
        val otherTime = DateFormat.getDateInstance().parse("1.1.1970").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla' color='#ff69b4' start_date='1437213300000' repeat_type='never'/>" +
        ...
        cal.add(Calendar.DAY_OF_YEAR, 1)
        assertNull(ev.isMarked(cal))
        cal.timeInMillis = otherTime
        val marked = ev.isMarked(cal)
        assertNotNull(marked)
        assertEquals("bla2", marked.name)
        cal.add(Calendar.DAY_OF_YEAR, 1)
        assertNull(ev.isMarked(cal))
    }

    @Throws(Exception::class)
    fun testCalendarMarkingRepeatWeekly() {
        val startTime = DateFormat.getDateInstance().parse("5.7.2015").time
        val endTime = DateFormat.getDateInstance().parse("19.7.2015").time
        val inputString = "<calendar_markings>" +
                ...
                "</calendar_markings>"
        println(inputString)
        val result = XmlBindingTools.getInstance().unMarshall(inputString) as CalendarMarkings
        assertEquals(1, result.sizeCalendarMarkingList())
        val ev = CalendarMarkingEvaluator(result)
        val cal = Calendar.getInstance()
        cal.timeInMillis = result.getCalendarMarking(0).startDate
    ...
    @Throws(Exception::class)
    fun testCalendarMarkingRepeatBeWeekly() {
        val startTime = DateFormat.getDateInstance().parse("5.7.2015").time
        val endTime = DateFormat.getDateInstance().parse("19.7.2015").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
    ...
    @Throws(Exception::class)
    fun testCalendarMarkingRepeatDaily() {
        val startTime = DateFormat.getDateInstance().parse("5.7.2015").time
        val endTime = DateFormat.getDateInstance().parse("19.7.2015").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
    ...
    @Throws(Exception::class)
    fun testCalendarMarkingRepeatMonthly() {
        val startTime = DateFormat.getDateInstance().parse("5.7.2015").time
        val endTime = DateFormat.getDateInstance().parse("5.8.2015").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
    ...
    @Throws(Exception::class)
    fun testCalendarMarkingRepeatYearly() {
        val startTime = DateFormat.getDateInstance().parse("5.7.2015").time
        val endTime = DateFormat.getDateInstance().parse("5.7.2016").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
    ...
    @Throws(Exception::class)
    fun testCalendarMarkingRepeatYearlyEveryNthDay() {
        val startTime = DateFormat.getDateInstance().parse("30.1.2015").time
        val endTime = DateFormat.getDateInstance().parse("29.2.2016").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
        ...
        assertNull(ev.isMarked(cal))
        val nextYearDate = DateFormat.getDateInstance().parse("30.1.2016").time
        cal.timeInMillis = nextYearDate
        assertNotNull(ev.isMarked(cal))
        cal.timeInMillis = endTime
        assertNotNull(ev.isMarked(cal))
     ...
     */
    @Throws(Exception::class)
    fun testCalendarMarkingRepeatYearlyEveryNthDayStartAfterFirstOccurrence() {
        val startTime = DateFormat.getDateInstance().parse("27.10.2015").time
        val endTime = DateFormat.getDateInstance().parse("29.2.2016").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
                "repeat_type='yearly_every_nth_day' repeat_each_n_occurence='30' first_occurence='30'/>" +
        ...
        //		ev.print();
        val cal = Calendar.getInstance()
        val nextYearDate = DateFormat.getDateInstance().parse("30.1.2015").time
        cal.timeInMillis = nextYearDate
        assertNull(ev.isMarked(cal))
        cal.add(Calendar.DAY_OF_YEAR, 30)
        assertNull(ev.isMarked(cal))
    ...
    @Throws(Exception::class)
    fun testCalendarMarkingRepeatWeeklyEveryNthDay() {
        val startTime = DateFormat.getDateInstance().parse("1.1.2015").time
        val endTime = DateFormat.getDateInstance().parse("1.3.2015").time
        val result = XmlBindingTools.getInstance().unMarshall("<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
        ...
        //		ev.print();
        val cal = Calendar.getInstance()
        cal.timeInMillis = DateFormat.getDateInstance().parse("3.1.2015").time
        assertNotNull(ev.isMarked(cal))
        cal.timeInMillis = DateFormat.getDateInstance().parse("8.1.2015").time
        assertNotNull(ev.isMarked(cal))
        cal.timeInMillis = DateFormat.getDateInstance().parse("9.1.2015").time
        assertNull(ev.isMarked(cal))
    }

    @Throws(Exception::class)
    fun testCalendarMarkingRepeatYearlyEveryNthWeek() {
        val startTime = DateFormat.getDateInstance().parse("9.1.2015").time
        val endTime = DateFormat.getDateInstance().parse("13.2.2016").time
        val inputString = "<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
        ...
        ev.print()
        val cal = Calendar.getInstance()
        cal.timeInMillis = DateFormat.getDateInstance().parse("5.2.2016").time
        assertNull(ev.isMarked(cal))
    }

    @Throws(Exception::class)
    fun testCalendarMarkingRepeatYearlyEveryNthWeekStrangeDates() {
        val startTime = DateFormat.getDateInstance().parse("9.1.2015").time
        val endTime = DateFormat.getDateInstance().parse("9.1.2016").time
        val inputString = "<calendar_markings>" +
                "  <calendar_marking name='bla2' color='#ff69b5' start_date='" + startTime + "' end_date='" + endTime + "' " +
        ...
        val ev = CalendarMarkingEvaluator(result)
        ev.print()
        val nEntries = ev.getAtLeastTheFirstNEntries(10)

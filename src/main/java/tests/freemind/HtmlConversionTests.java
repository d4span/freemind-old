...
//		rootNode.getNode().setText("myRoot");
//		NodeCreator creator = new NodeCreator() {
//
//			@Override
//			public NodeRepresentation createChild(NodeRepresentation pParent) {
//				created.increase();
//				System.out.println("Create new node as child of: " + pParent.getNode().getText());
...
//		rootNode.getNode().setText("myRoot2");
...
//		created.setValue(0);
//		rootNode = new TestMindMapNode();
//		rootNode.getNode().setText("myRoot3");

 ...
 * @date 27.08.2013
 */
class LastOpenedTests : FreeMindTestBase() {
    @Throws(Exception::class)
    fun testStrangeCharsInList() {
        val list = LastOpenedList(Controller(frame), null)
        val name = "test.mm"
        val file = "/home/user/tmp&tmp/$name"
        println(File(file).absoluteFile)
        val restorable = "MindMap:"

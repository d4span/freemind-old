 ...
 */
    ...
    override fun startupMapHook() {
        ...
        val initialMapModule = mainController!!.mapModule
        val modules = mapModules
        // to prevent concurrent modification:
        val v = Vector<MapModule>()
        v.addAll(modules.values)
        for (module in v) {
            // change to module to display map properly.
            mainController.mapModuleManager!!.changeToMapModule(
                    module.toString())
            if (!module.modeController.save()) {
                // if not successfully, break the action.
                JOptionPane
                        .showMessageDialog(
                                getController()!!.frame.getContentPane(),
                                "FreeMind",
    ...
    /**
     */
    private val mapModules: Map<String, MapModule>
        private get() = getController()!!.controller.getMapModuleManager()
                .getMapModules()
}
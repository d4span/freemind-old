...
/** Creates a new instance of XmlExporter  */
{
    ...
    fun transForm(xmlFile: File?, xsltFile: File?, resultFile: File?) {
        val xmlSource: Source = StreamSource(xmlFile)
        // System.out.println("set xsl");
        val xsltSource: Source = StreamSource(xsltFile)
        // System.out.println("set result");
        val resultOutputStream = FileOutputStream(resultFile)
        val result: Result = StreamResult(resultOutputStream)

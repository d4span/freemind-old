...
class NumberProperty(override var description: String, override var label: String, private val min: Int, private val max: Int,
        ...
        set(value) {
            ...
            try {
                ...
                if (intValue < min || intValue > max || stepModul != 0) {
                    System.err.println("Actual value of property " + label

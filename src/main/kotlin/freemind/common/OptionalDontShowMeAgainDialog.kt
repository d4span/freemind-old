 ...
 * @author foltin
 */
class OptionalDontShowMeAgainDialog(pFrame: JFrame, pComponent: Component?,
     ...
     *
     */
    class StandardPropertyHandler(private val mController: Controller,
                                  private val mPropertyName: String) : DontShowPropertyHandler {
    ...
    fun show(): OptionalDontShowMeAgainDialog {
        ...
        mDialog!!.contentPane.add(
                ...
                GridBagConstraints(1, 0, 1, 1, 10.0, 4.0,
        ...
        mDialog!!.contentPane.add(
                mDontShowAgainBox,
                GridBagConstraints(0, 2, 3, 1, 1.0, 1.0,
                        GridBagConstraints.WEST, GridBagConstraints.BOTH,
                        Insets(5, 5, 0, 0), 0, 0))
        ...
        mDialog!!.contentPane.add(
                okButton,
                GridBagConstraints(2, 3, 1, 1, 1.0, 1.0,
                        GridBagConstraints.WEST, GridBagConstraints.BOTH,
                        Insets(5, 5, 0, 0), 0, 0))
        ...
        mDialog!!.contentPane.add(
                cancelButton,
                GridBagConstraints(3, 3, 1, 1, 1.0, 1.0,
                        GridBagConstraints.WEST, GridBagConstraints.BOTH,
                        Insets(5, 5, 0, 0), 0, 0))

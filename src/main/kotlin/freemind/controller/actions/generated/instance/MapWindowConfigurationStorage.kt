...
/* MapWindowConfigurationStorage...*/   class MapWindowConfigurationStorage : WindowConfigurationStorage() {
    ...
    val listTableColumnSettingList: List<*>
        get() = Collections.unmodifiableList(tableColumnSettingList)
    protected var tableColumnSettingList: MutableList<TableColumnSetting?> = mutableListOf()
    ...
    val listMapLocationStorageList: List<*>
        get() = Collections.unmodifiableList(mapLocationStorageList)
    protected var mapLocationStorageList: MutableList<MapLocationStorage?> = mutableListOf()

 ...
 */(private val attribute: String?) : NodeCondition() {
    ...
    override fun createDesctiption(): String? {
        val simpleCondition = Resources.instance
                ?.getResourceString(ConditionFactory.Companion.FILTER_DOES_NOT_EXIST)
        return ConditionFactory.Companion.createDescription(attribute, simpleCondition,
                null, false)
    }

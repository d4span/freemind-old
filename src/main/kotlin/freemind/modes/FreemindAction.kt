 ...
 * @date 22.10.2013
 */
abstract class FreemindAction(title: String?, icon: Icon?,
                              val controllerAdapter: ControllerAdapter?) : AbstractAction(title, icon), MenuItemEnabledListener {
    ...
    constructor(title: String?,
                controllerAdapter: ControllerAdapter) : this(title, null as String?, controllerAdapter) {
    }
    ...
    constructor(title: String?, iconPath: String?,
                controllerAdapter: ControllerAdapter) : this(controllerAdapter.getText(title), if (iconPath == null) null else ImageFactory.getInstance().createIcon(controllerAdapter.getResource(iconPath)),
            controllerAdapter) {
    }
    ...
    override fun isEnabled(pItem: JMenuItem?, pAction: Action?): Boolean {
        val result = controllerAdapter != null && controllerAdapter.map != null
        logger!!.finest("isEnabled " + pAction!!.getValue(NAME) + "=" + result + " from " + controllerAdapter)
        return result
    }

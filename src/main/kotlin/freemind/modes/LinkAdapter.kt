...
abstract class LinkAdapter(override var source: MindMapNode?, target: MindMapNode?,
                           pMapFeedback: MapFeedback?) : LineAdapter(target, pMapFeedback), MindMapLink {
    override var destinationLabel: String? = null
    ...
    protected class LinkAdapterListener : FreemindPropertyListener {
        override fun propertyChanged(propertyName: String, newValue: String,
                                     oldValue: String) {
            if (propertyName == FreeMind.RESOURCES_LINK_COLOR) {
    ...
    companion object {
        protected val standardStylePropertyString = "standardlinkstyle"
            protected get() = Companion.field
        private var standardColor: Color? = null
        private var standardStyle: String? = null
        private var listener: LinkAdapterListener? = null
    }
}
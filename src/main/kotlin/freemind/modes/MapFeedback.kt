...
java.awt.*
/**
 * This interface describes the services, the [ModeController] provides to
...
interface MapFeedback {
     ...
     */
    fun fireNodePreDeleteEvent(node: MindMapNode?)

    /**
     * Is issued after a node is deleted. It is issued via
     * NodeLifetimeListener.
     */
    fun fireNodePostDeleteEvent(node: MindMapNode?, parent: MindMapNode?)

    /**
     * @param pNode
     */
    fun firePreSaveEvent(pNode: MindMapNode?)

    /**
     * Invoke this method after you've changed how a node is to be represented
     * in the tree.
     */
    fun nodeChanged(node: MindMapNode?)
    fun nodeRefresh(node: MindMapNode?)
    fun fireRecursiveNodeCreateEvent(node: MindMapNode?)

    /**
     * @see ModeController.paste
     */
    fun paste(pNode: MindMapNode?,
              pParent: MindMapNode?)
    ...
    fun getResourceString(pTextId: String?): String?
     ...
     * @param pValue
     */
    fun setProperty(pProperty: String?, pValue: String?)

    /**
     * Show the message to the user.
     * @param pFormat
     */
    fun out(pFormat: String?)
     ...
     * @return
     */
    fun getFontThroughMap(pFont: Font): Font?
     ...
     * @return
     */
    fun createNodeHook(pLoadName: String?, pNode: MindMapNode): NodeHook?

    /**
     * @param pNode
     * @param pModel
     */
    fun invokeHooksRecursively(pNode: MindMapNode?, pModel: MindMap?)

    /**
     * @return a ViewAbstraction, if a view is attached, null otherwise.
     */
    val viewAbstraction: ViewAbstraction?

    /**
     * @return null, if no feedback is available.
     */
    val viewFeedback: ViewFeedback
    fun sortNodesByDepth(inPlaceList: List<MindMapNode?>)
}
...
interface MindMapArrowLink : MindMapLink {
    /* for arrows: */ // the zero is the start point of the
    var startInclination: Point?

    // line;
    // the zero is the end point of the line;
    var endInclination: Point?

    /** the type of the start arrow: currently "None" and "Default".  */
    val startArrow: String?
     ...
     * TODO
     */
    fun changeInclination(map: MapView, originX: Int, originY: Int,
                          deltaX: Int, deltaY: Int)

    fun showControlPoints(bShowControlPointsFlag: Boolean)
    val showControlPointsFlag: Boolean
    fun save(): XMLElement?
    ...
    companion object {
         ...
         */
        const val ARROW_DEFAULT = "Default"

        /**
         * Means: no, it hasn't an arrow at this side.
         */
        const val ARROW_NONE = "None"
    }
}
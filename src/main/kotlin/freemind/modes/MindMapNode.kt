...
freemind.modes.attributes.Attributeimport java.awt.*import java.io.*
import javax.swing.event.*
import javax.swing.tree.TreePath

interface MindMapNode : MutableTreeNode {
    /**
     ...
     */
    fun childrenFolded(): ListIterator<MindMapNode?>?

    /**
     * @return returns a ListIterator of all (and not only the unfolded ones!!)
     * children of the node.
     */
    fun childrenUnfolded(): ListIterator<MindMapNode?>?
     ...
     */
    fun sortedChildrenUnfolded(): ListIterator<MindMapNode>?
     ...
     */
    fun getChildPosition(childNode: MindMapNode?): Int
    val nodeLevel: Int
    var link: String?
...
protected get() {
     ...
     */
    fun isDescendantOf(node: MindMapNode): Boolean
     ...
     * @see isDecendantOf
     */
    fun isDescendantOfOrEqual(pParentNode: MindMapNode): Boolean
    val isRoot: Boolean
    ...
    fun save(writer: Writer?, registry: MindMapLinkRegistry?,

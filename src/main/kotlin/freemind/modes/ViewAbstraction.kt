...
interface ViewAbstraction {
     ...
     * @param node
     */
    fun deselect(node: NodeView?)
    fun getNodeView(node: MindMapNode?): NodeView?
    fun isSelected(n: NodeView?): Boolean
    val selecteds: LinkedList<NodeView?>
    val selected: NodeView?
     ...
     */
    val selectedNodesSortedByY: ArrayList<MindMapNode?>?
}
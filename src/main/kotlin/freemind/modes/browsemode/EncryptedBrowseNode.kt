 ...
 * @author foltin
 */
class EncryptedBrowseNode(userObject: Any?, private val mMapFeedback: MapFeedback) : BrowseNodeModel(userObject, mMapFeedback.map) {
    ...
    override fun setFolded(folded: Boolean) {
        ...
        // get password:
        val pwdDialog = EnterPasswordDialog(null,
        ...
        if (pwdDialog.result == EnterPasswordDialog.Companion.CANCEL) {
            return
        }
        ...
        val childs: Array<String> = decrypted.split(ModeController.Companion.NODESEPARATOR).toTypedArray()
        // and now? paste it:

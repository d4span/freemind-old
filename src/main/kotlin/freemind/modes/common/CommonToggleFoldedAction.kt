 ...
 * @author foltin
 */
class CommonToggleFoldedAction(private val modeController: ControllerAdapter) : AbstractAction(modeController.getText("toggle_folded")) {
    ...
    @JvmOverloads
    fun toggleFolded(listIterator: ListIterator<*>? = modeController.selecteds.listIterator()) {
        val fold = getFoldingState(reset(listIterator))
        val i: Iterator<MindMapNode>? = reset(listIterator)
        while (i!!.hasNext()) {
            val node = i.next()
    ...
    companion object {
        fun reset(iterator: ListIterator<*>?): ListIterator<*>? {

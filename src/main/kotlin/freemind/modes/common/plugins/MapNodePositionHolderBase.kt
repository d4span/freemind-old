 ...
 */
    ...
    protected val isTooltipDesired: Boolean
        protected get() = Resources.getInstance().getBoolProperty(NODE_MAP_SHOW_TOOLTIP) &&
                !safeEquals(mTooltipLocation, "false")
    ...
    val barePosition: Array<String?>
        get() = arrayOf(mValues!![XML_STORAGE_POS_LAT],
    ...
    companion object {
        ...
        val mapLocationIcon: ImageIcon?
            get() {
                ...
                if (sMapLocationIcon == null) {
                    sMapLocationIcon = ImageFactory.getInstance().createUnscaledIcon(Resources.getInstance()
        ...
        fun getBaseHook(node: MindMapNode?): MapNodePositionHolderBase? {
            for (element in node.getActivatedHooks()) {

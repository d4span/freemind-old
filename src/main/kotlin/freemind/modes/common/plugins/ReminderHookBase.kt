 ...
 */
    ...
    private fun scheduleTimer() {
        timer = Timer(remindUserAtAsSecondsFromNow,
    ...
    private val clockIcon: ImageIcon?
        private get() {
            ...
            if (Companion.clockIcon == null) {
                Companion.clockIcon = MindIcon.Companion.factory("clock2").getIcon()
            }
    ...
    private val bellIcon: ImageIcon?
        private get() {
            ...
            if (Companion.bellIcon == null) {
                Companion.bellIcon = MindIcon.Companion.factory("bell").getIcon()
            }
    ...
    private val flagIcon: ImageIcon?
        private get() {
            ...
            if (Companion.flagIcon == null) {
                Companion.flagIcon = MindIcon.Companion.factory("flag").getIcon()
            }
    ...
    inner class TimerBlinkTask(stateAdded: Boolean) : ActionListener {
        ...
        override fun actionPerformed(pE: ActionEvent) {
            ...
            remindUserAt = (System.currentTimeMillis()
                    + BLINK_INTERVAL_IN_MILLIES) // 3
            displayState(if (stateAdded) CLOCK_VISIBLE else CLOCK_INVISIBLE,
                    getNode(), true)
        }
    }
    ...
    abstract override fun setToolTip(node: MindMapNode?, key: String?,
                                     value: String?)
    ...
    private val STATE_TOOLTIP = (TimerBlinkTask::class.java.name
            + "_STATE_")

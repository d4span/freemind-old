 ...
 */
class JAutoScrollBarPane
/**
 */
(view: Component?) : JScrollPane(view, VERTICAL_SCROLLBAR_NEVER, HORIZONTAL_SCROLLBAR_NEVER) {
    override fun doLayout() {
        super.doLayout()
        val insets = insets
        val insetHeight = insets.top + insets.bottom
        val prefSize = getViewport().preferredSize
        var height = height - insetHeight
        if (getHorizontalScrollBar().isVisible) {
            height -= getHorizontalScrollBar().height
        }
        val isVsbNeeded = height < prefSize.height

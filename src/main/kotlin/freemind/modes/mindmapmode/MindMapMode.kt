...
open class MindMapMode : Mode() {
    override var controller: Controller? = null
        private set
    private var modecontroller: MindMapController? = null
    private val MODENAME = "MindMap"
    ...
    override fun init(c: Controller) {
        ...
        modecontroller = createModeController() as MindMapController
    }

    override fun createModeController(): ModeController {
        logger!!.finest("Creating new MindMapController...")
        val mindMapController = MindMapController(this)
    ...
    override fun activate() {
        if (isRunning) {
            controller!!.mapModuleManager!!.changeToMapOfMode(this)
        } else {
            isRunning = true
        }
    }
    ...
    override val defaultModeController: ModeController?
        get() = modecontroller

 ...
 * @author foltin
 */
class CloudAction(controller: MindMapController) : NodeGeneralAction(controller, "cloud", "images/Cloud24.gif"), MenuItemSelectedListener {
    init {
        setDoActionClass(doActionClass)
    }

    val doActionClass: Class<AddCloudXmlAction>
        get() = AddCloudXmlAction::class.java

    override fun isSelected(pCheckItem: JMenuItem?, pAction: Action?): Boolean {
        return modeController.selected.cloud != null
    }
}
...
class CloudColorAction(controller: MindMapController) : MindmapAction("cloud_color", "images/Colors24.gif", controller), MenuItemEnabledListener {
    ...
    override fun actionPerformed(e: ActionEvent) {
        ...
        if (controller.getSelected().cloud != null) {
            selectedColor = controller.getSelected().cloud.color
        }
        val color = Controller.showCommonJColorChooserDialog(controller
                .getView().selected, controller
                .getText("choose_cloud_color"), selectedColor) ?: return
        for (selected in controller.getSelecteds()) {
    ...
    override fun isEnabled(item: JMenuItem?, action: Action?): Boolean {
        return (super.isEnabled(item, action) && controller != null && controller.selected != null
                && controller.selected.cloud != null)
    }
}
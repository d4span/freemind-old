...
class ColorArrowLinkAction(private val controller: MindMapController,
                           var arrowLink: MindMapArrowLinkModel?) : MindmapAction("arrow_link_color", "images/Colors24.gif", controller) {
    override fun actionPerformed(e: ActionEvent) {
        val selectedColor = arrowLink!!.color!!
        val color = Controller.showCommonJColorChooserDialog(controller
                .view.selected, this.getValue(NAME) as String,

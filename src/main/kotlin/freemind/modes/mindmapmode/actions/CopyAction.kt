...
javax.swing.*
class CopyAction(private val controller: MindMapController) : AbstractAction(controller.getText("copy"), ImageFactory.getInstance().createIcon(
    ...
    override fun actionPerformed(e: ActionEvent) {
        if (controller.map != null) {
            val copy = controller.copy()
            if (copy != null) {
                controller.clipboardContents = copy
            }
        }
    }
}
...
class DeleteChildAction(private val mMindMapController: MindMapController) : MindmapAction("remove_node", "images/editdelete.png", mMindMapController) {
    override fun actionPerformed(e: ActionEvent) {
        // ask user if not root is selected:
        for (node in mMindMapController.selecteds) {
            if (node!!.isRoot) {
    ...
    val doActionClass: Class<DeleteNodeAction>

...
javax.swing.*
class EdgeStyleAction(controller: MindMapController, style: String?) : NodeGeneralAction(controller, null, null), MenuItemSelectedListener {
    ...
    override fun getActionPair(pSelected: MindMapNodeModel): ActionPair? {
        return mindMapController.actorFactory.edgeStyleActor.getActionPair(pSelected, mStyle)
    }
    ...
    override fun isSelected(pCheckItem: JMenuItem?, pAction: Action?): Boolean {
        val style = mindMapController.selected.edge.style
        return safeEquals(style, mStyle)
    }
}
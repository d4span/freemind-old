 ...
 * @author foltin
 */
class FontSizeAction(modeController: MindMapController) : NodeGeneralAction(modeController, "font_size", null, null as NodeActorXml?) {
    /** This action is used for all sizes, which have to be set first.  */
    private var actionSize: String?

    /**
     */
    init {
        // default value:
        actionSize = modeController.frame.getProperty("defaultfontsize")
    }

    fun actionPerformed(size: String?) {
        actionSize = size
    ...
    override fun getActionPair(pSelected: MindMapNodeModel): ActionPair? {
        return mindMapController.actorFactory.fontSizeActor.getActionPair(pSelected, actionSize)
    }
}
...
javax.swing.*
class ItalicAction(modeController: MindMapController) : NodeGeneralAction(modeController, "italic", "images/Italic16.gif"), MenuItemSelectedListener {
    ...
    init {
        ...
        setDoActionClass(ItalicNodeAction::class.java)
    }

    override fun isSelected(item: JMenuItem?, action: Action?): Boolean {
        return modeController.selected.isItalic
    }
}
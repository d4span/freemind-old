...
javax.swing.*
class MindMapControllerHookAction(override var hookName: String?,
                                  var mindMapController: MindMapController) : AbstractAction(hookName), HookAction, MenuItemEnabledListener {
    override fun actionPerformed(arg0: ActionEvent) {
        if (null == mindMapController.map) {
            return
        }
        mindMapController.createModeControllerHook(hookName)
    }
    ...
    override fun isEnabled(pItem: JMenuItem?, pAction: Action?): Boolean {
        return mindMapController.map != null
    }
}
 ...
 * @author foltin
 */
abstract class MindmapAction
/**
 * @param title
 * is a fixed title (no translation is done via resources)
 */(title: String?, icon: Icon?,
    val mindMapController: MindMapController) : FreemindAction(title, icon, mindMapController) {
    ...
    constructor(title: String?,
                mindMapController: MindMapController) : this(title, null as String?, mindMapController) {
    }
    ...
    constructor(title: String?, iconPath: String?,
                mindMapController: MindMapController) : this(mindMapController.getText(title), if (iconPath == null) null else ImageFactory.getInstance().createIcon(mindMapController.getResource(iconPath)),
            mindMapController) {
    }

    open fun addActor(actor: ActorXml?) {
        // registration:
        mindMapController.actionRegistry.registerActor(actor,

...
class NewPreviousSiblingAction(private val controller: MindMapController) : MindmapAction("new_sibling_before", controller) {
    override fun actionPerformed(e: ActionEvent) {
        controller.addNew(controller.selected,
                MindMapActions.Companion.NEW_SIBLING_BEFORE, null)
    }
}
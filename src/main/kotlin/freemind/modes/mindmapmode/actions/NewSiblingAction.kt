...
class NewSiblingAction(private val controller: MindMapController) : MindmapAction("new_sibling_behind", controller) {
    override fun actionPerformed(e: ActionEvent) {
        controller.addNew(controller.selected,
                MindMapActions.Companion.NEW_SIBLING_BEHIND, null)
    }
}
...
class NodeColorAction(private val controller: MindMapController) : MindmapAction("node_color", null as String?, controller) {
    override fun actionPerformed(e: ActionEvent) {
        val color = Controller.showCommonJColorChooserDialog(controller
                .view.selected, controller
                .getText("choose_node_color"), controller.selected
                .color) ?: return

 ...
 * @author foltin
 */
class RemoveIconAction(modeController: MindMapController) : NodeGeneralAction(modeController, "remove_last_icon", "images/remove.png"), IconInformation {
    /**
     */
    init {
        setDoActionClass(RemoveIconXmlAction::class.java)
    }

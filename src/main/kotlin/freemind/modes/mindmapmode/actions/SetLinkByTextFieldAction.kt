...
class SetLinkByTextFieldAction(private val controller: MindMapController) : MindmapAction("set_link_by_textfield", controller) {
    override fun actionPerformed(e: ActionEvent) {
        var inputValue = JOptionPane.showInputDialog(controller.view
                .selected, controller.getText("edit_link_manually"),
                controller.selected.link)
        if (inputValue != null) {
            if (inputValue == "") {
                inputValue = null // In case of no entry unset link
            }
            controller.setLink(controller.selected, inputValue)
        }
    }
}
...
class ToggleChildrenFoldedAction(private val modeController: MindMapController) : MindmapAction("toggle_children_folded", modeController) {
    override fun actionPerformed(e: ActionEvent) {
        val selected = modeController.selected
        modeController.actorFactory.toggleFoldedActor.toggleFolded(selected.childrenUnfolded())
        val mapView = modeController.view

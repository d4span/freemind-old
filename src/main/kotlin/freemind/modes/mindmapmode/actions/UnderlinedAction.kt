...
javax.swing.*
class UnderlinedAction(modeController: MindMapController) : NodeGeneralAction(modeController, "underlined", "images/Underline24.gif"), MenuItemSelectedListener {
    private override val modeController: MindMapController

    /**
     */
    init {
        this.modeController = modeController
        setDoActionClass(UnderlinedNodeAction::class.java)
    }

    override fun isSelected(item: JMenuItem?, action: Action?): Boolean {
        return modeController.selected.isUnderlined
    }
}
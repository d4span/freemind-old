 ...
 * @author foltin
 */
abstract class AbstractXmlAction protected constructor(name: String?, icon: Icon?,
                                                       /**
                                                        */
                                                       override val mindMapController: MindMapController) : MindmapAction(name, icon, mindMapController) {
    /**
     */
    var actor: ActorXml? = null
        private set
    ...
    protected val shortDescription: String
        protected get() = getValue(SHORT_DESCRIPTION) as String

    /**
     */
    protected abstract fun xmlActionPerformed(arg0: ActionEvent?)
    override fun addActor(actor: ActorXml?) {
        this.actor = actor
        if (actor != null) {
            // registration:

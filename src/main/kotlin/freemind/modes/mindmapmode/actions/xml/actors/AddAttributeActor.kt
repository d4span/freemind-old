...
class AddAttributeActor(pMapFeedback: ExtendedMapFeedback) : XmlActorAdapter(pMapFeedback) {
    ...
    override val doActionClass: Class<*>
        get() = AddAttributeAction::class.java

    fun getActionPair(selected: MindMapNode, pAttribute: Attribute?): ActionPair {
        val setAttributeAction = getAddAttributeAction(selected,
                pAttribute)
     ...
     * @return
     */
    fun getAddAttributeAction(pSelected: MindMapNode?,
                              pAttribute: Attribute?): AddAttributeAction {
        val addAttributeAction = AddAttributeAction()
        addAttributeAction.node = getNodeID(pSelected)
        addAttributeAction.name = pAttribute.getName()
        addAttributeAction.value = pAttribute.getValue()

...
(pMapFeedback: ExtendedMapFeedback) : XmlActorAdapter(pMapFeedback) {
    ...
    override val doActionClass: Class<*>
        get() = SetAttributeAction::class.java

    fun getActionPair(selected: MindMapNode, pPosition: Int, pAttribute: Attribute?): ActionPair {
        val setAttributeAction = getSetAttributeAction(selected, pPosition, pAttribute)
        val undoSetAttributeAction = getSetAttributeAction(selected, pPosition, selected.getAttribute(pPosition))
        return ActionPair(setAttributeAction, undoSetAttributeAction)
    }

    fun setAttribute(pSelected: MindMapNode,
                     pPosition: Int, pAttribute: Attribute?) {
        val actionPair = getActionPair(pSelected, pPosition, pAttribute)
        execute(actionPair)
    }
     ...
     * @return
     */
    fun getSetAttributeAction(pSelected: MindMapNode?,
                              pPosition: Int, pAttribute: Attribute?): SetAttributeAction {
        val setAttributeAction = SetAttributeAction()
        setAttributeAction.node = getNodeID(pSelected)
        setAttributeAction.name = pAttribute.getName()
        setAttributeAction.value = pAttribute.getValue()
        setAttributeAction.position = pPosition

 ...
 * @author foltin
 */
class DatabaseConnectionHook : DatabaseBasics(), PermanentNodeHook, DontSaveMarker {
    /**
     *
     */
    override fun startupMapHook() {
        ...
        DatabaseBasics.Companion.logger!!.info("Startup of the permanent hook.")
        return
    }
    ...
    override fun shutdownMapHook() {
        ...
        DatabaseBasics.Companion.logger!!.info("Shut down of the permanent hook.")
        shutdownConnection()

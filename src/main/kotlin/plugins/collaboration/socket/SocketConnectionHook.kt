 ...
 * @author foltin
 */
class SocketConnectionHook : SocketBasics(), PermanentNodeHook, DontSaveMarker {
    /**
     * @param pClientCommunication
     */
    var clientCommunication: ClientCommunication? = null
    ...
    override val port: Int
        get() = clientCommunication.getPort()
    ...
    override fun lock(pUserName: String?, pController: ExtendedMapFeedback?): String? {
        return clientCommunication!!.sendLockRequest()
    }
    ...
    override fun broadcastCommand(pDoAction: String?, pUndoAction: String?,
        ...
        clientCommunication!!.sendCommand(pDoAction, pUndoAction, pLockId)
    }
    ...
    override fun getMasterInformation(pController: ExtendedMapFeedback?): CollaborationUserInformation? {
        return if (clientCommunication != null) {
            clientCommunication.getUserInfo()
        } else CollaborationUserInformation()
    }

...
class MapMarkerLocation(val nodePositionHolder: MapNodePositionHolder?, pMapDialog: MapDialog) : MapMarkerBase(pMapDialog) {
     ...
     */
    fun update() {
        val node: MindMapNode = nodePositionHolder!!.getNode()
        text = node.text
    ...
    override fun getLat(): Double {
        return nodePositionHolder.getPosition().lat
    }

    override fun getLon(): Double {
        return nodePositionHolder.getPosition().lon
    }

    override fun toString(): String {
        return ("MapMarkerLocation for node "
                + nodePositionHolder!!.getNode()!!.text + " at " + lat
                + " " + lon)
    }

    override fun setLat(pLat: Double) {
        nodePositionHolder.getPosition().lat = pLat
    }

    override fun setLon(pLon: Double) {
        nodePositionHolder.getPosition().lon = pLon
    }
}
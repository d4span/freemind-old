 ...
 * @author foltin
 */
class DontShowAgainDialogTests : FreeMindTestBase() {
    @Throws(Exception::class)
    fun testDialog() {
        var showResult: Int
        val frame = JFrame()
        frame.isVisible = true
        showResult = OptionalDontShowMeAgainDialog(frame, frame, "message",
                "title", object : TextTranslator {
            override fun getText(pKey: String?): String {
                return "?$pKey?"
            }
        }, object : DontShowPropertyHandler {
            override var property: String
                get() = ""
                set(pValue) {
                    println("Property Result: '$pValue'")
                }
        }, OptionalDontShowMeAgainDialog.ONLY_OK_SELECTION_IS_STORED)
                .show().result
        println(showResult)
        showResult = OptionalDontShowMeAgainDialog(frame, frame,
                "message NO SHOW", "title", object : TextTranslator {
            override fun getText(pKey: String?): String {
                return "?$pKey?"
            }
        }, object : DontShowPropertyHandler {
        ...
        showResult = OptionalDontShowMeAgainDialog(frame, frame,
            ...
            override var property: String
                ...
                .show().result
        showResult = OptionalDontShowMeAgainDialog(
                frame,
                frame,
                "message remind",
                "title",

...
object AllTests {
    ...
    fun suite(): Test {
        val suite = TestSuite("AllTests")
        // $JUnit-BEGIN$
        suite.addTest(TestSuite(ScriptEditorPanelTest::class.java))
        //		suite.addTest(new TestSuite(SplashTests.class));
        suite.addTest(TestSuite(Base64Tests::class.java))
        suite.addTest(TestSuite(FindTextTests::class.java))
        suite.addTest(TestSuite(HtmlConversionTests::class.java))
        suite.addTest(TestSuite(TransformTest::class.java))
        suite.addTest(TestSuite(MarshallerTests::class.java))
        suite.addTest(TestSuite(SignedScriptTests::class.java))
        suite.addTest(TestSuite(LastStorageManagementTests::class.java))
        suite.addTest(TestSuite(ToolsTests::class.java))
        suite.addTest(TestSuite(ExportTests::class.java))
        suite.addTest(TestSuite(LayoutTests::class.java))
        suite.addTest(TestSuite(LastOpenedTests::class.java))
        suite.addTest(TestSuite(StandaloneMapTests::class.java))
        suite.addTest(TestSuite(CollaborationTests::class.java))
        suite.addTest(TestSuite(CalendarMarkingTests::class.java))
        // $JUnit-END$
        return suite
    }
}